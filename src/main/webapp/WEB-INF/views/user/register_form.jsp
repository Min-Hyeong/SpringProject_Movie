	...
	<body>
		<form method="POST">
			...
			<div class="form-group2">
				...
				<input type="text" id="user_birth" name="user_birth" placeholder="ex) 19990415" required>
				...
				<input type="text" id="user_phone" name="user_phone" placeholder="Phone Number" required>
			...
			<div class="reg_button">
				...
				<input type="button" value="가입하기" onclick="singup(this.form);">
			</div>
		</form>
	</body>
</html>